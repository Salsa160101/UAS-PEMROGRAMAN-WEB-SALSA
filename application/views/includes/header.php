...
<head>
  ...
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-T3c6CoIi6uLrA9TneNEoa7RxnatzjcDSCmG1MXxSR1GAsXEV/Dwwykc2MPK8M2HN" crossorigin="anonymous">
	...
	<!-- Compressed Styles -->
	<link href="<?=base_url()?>public/css/slides.min.css" rel="stylesheet" type="text/css">
	...
	<!-- Compressed Scripts -->
	<script src="<?=base_url()?>public/js/slides.min.js" type="text/javascript"></script>
...
<nav class="panel top">
  <div class="sections desktop">
    <div class="left"><a href="#menu" title="Slides Framework">TourAndTravel</a></div>
    <div class="center">
      <ul class="menu">
        <li><a href="http://localhost/cicrud/">Tour</a></li>
        <li><a href="http://localhost/cicrud/pages/service">Sevice</a></li>
        <li><a href="http://localhost/cicrud/pages/price">Pricing</a></li>
        <li><a href="http://localhost/cicrud/pages/contact">Contact</a></li>
      </ul>
    </div>
    <div class="right"><a class="button blue gradient" href="http://localhost/cicrud/user">Pemesanan</a></div>
  </div>
